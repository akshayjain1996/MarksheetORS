...
public class DBAdapter extends SQLiteOpenHelper {
	 ...
	 * Name of Database
	 */
	private static final String DB_NAME = "marksheetors.sqlite";
	/**
	 * Class for database Connected to
	 */
	...
	/**
	 * Database Adapter for FrontEnd & BackEnd Connection
	 */
	...
	private DBAdapter(Context context) {
		/**
		 * The Android's default system path for application database
		 */
